"""
Django settings for TREN_API project.
...
"""
# TODO Make sure you change the admin password when you push this api in production
...
WSGI_APPLICATION = 'TREN_API.wsgi.application'
